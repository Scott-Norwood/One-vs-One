...
#region ES3Cloud Actions
    ...
    public abstract class ES3CloudAction : SettingsAction
    {
        ...
        public override void OnReset()
        {
            url = "http://UnityWebRequest.myserver.com/ES3Cloud.php";
            errorCode = 0;
            cloud = null;
            fsmES3File = null;
        }
    ...
    public class ES3CloudDownloadFilenames : ES3CloudUserAction
    {
        ...
        [Tooltip("An optional search pattern containing '%' or '_' wildcards where '%' represents zero, one, or multiple characters, and '_' represents a single character. See https://UnityWebRequest.w3schools.com/sql/sql_like.asp for more info.")]
